...
namespace Jet_Search\Bricks_Views\Helpers\Controls_Converter;
...
class Control_Repeater extends Base {
	...
	public function parse_callback_argument_repeater_fields( $fields = [] ) {
		...
		foreach ( $fields as $field_name => $field_data ) {
			$prepared_fields[ $field_name ] = \Jet_Search\Bricks_Views\Helpers\Options_Converter::convert( $field_data );
		}
