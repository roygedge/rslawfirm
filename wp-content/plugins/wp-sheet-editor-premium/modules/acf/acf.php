	...
	class WP_Sheet_Editor_ACF {
		...
		public function add_settings_page_options( $sections ) {
			...
			$sections['misc']['fields'][] = array(
				...
				'type'          => 'new_select',
				'title'         => __( 'ACF: Manage values of "page links" and "post object" fields as:', 'vg_sheet_editor' ),
				'desc'          => __( 'Choose how to manage the values for these fields. Slugs can be more accurate if you have duplicate titles, while IDs are unique identifiers.', 'vg_sheet_editor' ),
				'options'       => array(
					''      => __( 'Titles', 'vg_sheet_editor' ),
					'slugs' => __( 'Slugs', 'vg_sheet_editor' ),
					'ids'   => __( 'IDs', 'vg_sheet_editor' ),
				),
				'default_value' => '',
			);
			return $sections;
